...
class CreateCollision(bpy.types.Operator):
    ...
    def nif_materials():
        items=[
            ("ALDUIN","Alduin",""),
            ("MATERIALARMORHEAVY","Armor Heavy",""),
            ("MATERIALARMORLIGHT","Armor Light",""),
            ("MATERIALARROW","Arrow",""),
            ("MATERIALASH","Ash",""),
            ("BARREL","Barrel",""),
            ("MATERIALBASKET","Basket",""),
            ("MATERIALBONE","Bone",""),
            ("BONEACTOR","Bone Actor",""),
            ("MATERIALBOOK","Book",""),
            ("BOTTLE","Bottle",""),
            ("MATERIALBOTTLESMALL","Bottle Small",""),
            ("MATERIALBOULDERLARGE","Boulder Large",""),
            ("MATERIALBOULDERMEDIUM","Boulder Medium",""),
            ("MATERIALBOULDERSMALL","Boulder Small",""),
            ("MATERIALCARPET","Carpet",""),
            ("MATERIALCARRIAGEWHEEL","Carriage Wheel",""),
            ("MATERIALCERAMICMEDIUM","Ceramic",""),
            ("MATERIALCHAIN","Chain",""),
            ("CLOTH","Cloth",""),
            ("MATERIALCOIN","Coin",""),
            ("DIRT","Dirt",""),
            ...
            ("GRAVEL","Gravel",""),
            ("ICE","Ice",""),
            ("MATERIALICEFORM","Ice Form",""),
            ("INSECT","Insect",""),
            ("MATERIALMEAT","Meat",""),
            ("MATERIALCHAINMETAL","Metal Chain",""),
            ("HEAVY METAL","Metal Heavy",""),
            ("MATERIALMETALLIGHT","Metal Light",""),
            ("SOLID METAL","Metal Solid",""),
            ("MUD","Mud",""),
            ("ORGANIC","Organic",""),
            ("ORGANICLARGE","Organic Large",""),
            ("MATERIALPOTSPANS","Pots and Pans",""),
            ("SAND","Sand",""),
            ("MATERIALSHIELDHEAVY","Shield Heavy",""),
            ("MATERIALSHIELDLIGHT","Shield Light",""),
            ("SKIN","Skin",""),
            ("MATERIALSKINLARGE","Skin Large",""),
            ("MATERIALSKINMETALLARGE","Skin Metal Large",""),
            ("MATERIALSKINMETALSMALL","Skin Metal Small",""),
            ("MATERIALSKINSKELETON","Skin Skeleton",""),
            ("MATERIALSKINSMALL","Skin Small",""),
            ("SNOW","Snow",""),
            ("STAIRSGLASS","Stairs Glass",""),
            ("STAIRSSNOW","Stairs Snow",""),
            ("STAIRSSTONE","Stairs Stone",""),
            ("STAIRSBROKENSTONE","Stairs Stone Broken",""),
            ("STAIRSWOOD","Stairs Wood",""),
            ("STONE","Stone ",""),
            ("MATERIALSTONEASSTAIRS","Stone as Stairs",""),
            ("BROKEN STONE","Broken Stone",""),
            ("HEAVY STONE","Stone Heavy",""),
            ("WARD","Ward",""),
            ("WATER","Water",""),
            ("MATERIALWATERPUDDLE","Water Puddle",""),
            ("MATERIALAXE1HAND","Weapon Axe",""),
            ("MATERIALBLOCKAXE","Weapon Axe Block",""),
            ("MATERIALBLADE1HAND","Weapon Blade 1Hand",""),
            ("MATERIALBLOCKBLADE1HAND","Weapon Blade 1Hand Block",""),
            ("MATERIALBLADE1HANDSMALL","Weapon Blade 1Hand Small",""),
            ("MATERIALBLADE2HAND","Weapon Blade 2Hand",""),
            ("MATERIALBLOCKBLADE2HAND","Weapon Blade 2Hand Block",""),
            ("MATERIALBLUNT1HAND","Weapon Blunt 1Hand",""),
            ("MATERIALBLOCKBLUNT","Weapon Blunt 1Hand Block",""),
            ("MATERIALBLUNT2HAND","Weapon Blunt 2Hand",""),
            ("MATERIALBLOCKBLUNT2HAND","Weapon Blunt 2Hand Block",""),
            ("MATERIALBOWSSTAVES","Weapon Bows and Staves",""),
            ("MATERIALBLOCKBOWSSTAVES","Weapon Bows and Staves Block",""),
            ("WEB","Web",""),
            ("WOOD","Wood",""),
            ("MATERIALWOODASSTAIRS","Wood as Stairs",""),
            ("HEAVY WOOD","Wood Heavy",""),
            ("LIGHT WOOD","Wood Light",""),
            ("METALGRATE","Metal Grate (Skywind only)",""),
            ("STAIRSMETAL","Stairs Metal (Skywind only)",""),
            ("THROWINGKNIFE","Throwing Knife (Skywind only)","")
        ]
    ...
    coll_material: bpy.props.EnumProperty(items=nif_materials(), name="Material", default="WOOD")
