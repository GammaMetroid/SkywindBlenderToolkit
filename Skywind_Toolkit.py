...
class CreateCollision(bpy.types.Operator):
    ...
    def nif_materials():
        items=[
            ...
            ("SKY_HAV_MAT_MATERIAL_BLOCK_BLADE_1HAND","Material Block Blade 1Hand","Material Block Blade 1Hand"),
            ("SKY_HAV_MAT_MATERIAL_MEAT","Material Meat","Material Meat"),
            ("SKY_HAV_MAT_MATERIAL_CARRIAGE_WHEEL","Material Carriage Wheel","Material Carriage Wheel"),
            ("SKY_HAV_MAT_MATERIAL_METAL_LIGHT","Material Metal Light","Material Metal Light"),
            ("SKY_HAV_MAT_LIGHT_WOOD","Light Wood","Light Wood"),
            ("SKY_HAV_MAT_SNOW","Snow","Snow"),
            ("SKY_HAV_MAT_GRAVEL","Gravel","Gravel"),
            ("SKY_HAV_MAT_MATERIAL_CHAIN_METAL","Material Chain Metal","Material Chain Metal"),
            ("SKY_HAV_MAT_BOTTLE","Bottle","Bottle"),
            ("SKY_HAV_MAT_WOOD","Wood","Wood"),
...
#            ("SKY_HAV_MAT_MATERIAL_CLOTH","Material Cloth","Material Cloth"),
            ...
            ("SKY_HAV_MAT_MATERIAL_BASKET","Material Basket","Material Basket"),
            ("SKY_HAV_MAT_ICE","Ice","Ice"),
...
#            ("SKY_HAV_MAT_MATERIAL_BONE_ACTOR","Material Bone Actor","Material Bone Actor"),
            ...
            ("SKY_HAV_MAT_SOLID_METAL","Solid Metal","Solid Metal"),
...
#            ("SKY_HAV_MAT_CHAIN_METAL","Chain Metal","Chain Metal"),
            ...
            ("SKY_HAV_MAT_STAIRS_SNOW","Stairs Snow","Stairs Snow"),
            ("SKY_HAV_MAT_HEAVY_STONE","Heavy Stone","Heavy Stone"),
...
#            ("SKY_HAV_MAT_MATERIAL_BLADE_2HAND_","Material Blade 2Hand ","Material Blade 2Hand "),
            ...
            ("SKY_HAV_MAT_MATERIAL_BLADE_2HAND","Material Blade 2Hand","Material Blade 2Hand"),
            ("SKY_HAV_MAT_MATERIAL_BOTTLE_SMALL","Material Bottle Small","Material Bottle Small"),
...
#            ("SKY_HAV_MAT_MATERIAL_STAIRS_WOOD","Material Stairs Wood","Material Stairs Wood"),
            ...
            ("SKY_HAV_MAT_MATERIAL_SKIN_LARGE","Material Skin Large","Material Skin Large"),
            ("SKY_HAV_MAT_ORGANIC","Organic","Organic"),
            ("SKY_HAV_MAT_MATERIAL_BONE","Material Bone","Material Bone"),
            ("SKY_HAV_MAT_HEAVY_WOOD","Heavy Wood","Heavy Wood"),
            ("SKY_HAV_MAT_MATERIAL_CHAIN","Material Chain","Material Chain"),
            ("SKY_HAV_MAT_DIRT","Dirt","Dirt"),
            ("SKY_HAV_MAT_GHOST","Ghost","Ghost"),
            ("SKY_HAV_MAT_MATERIAL_SKIN_METAL_LARGE","Material Skin Metal Large","Material Skin Metal Large"),
            ("SKY_HAV_MAT_MATERIAL_BLOCK_AXE","Material Block Axe","Material Block Axe"),
            ("SKY_HAV_MAT_MATERIAL_ARMOR_LIGHT","Material Armor Light","Material Armor Light"),
            ("SKY_HAV_MAT_MATERIAL_SHIELD_LIGHT","Material Shield Light","Material Shield Light"),
            ("SKY_HAV_MAT_MATERIAL_COIN","Material Coin","Material Coin"),
            ("SKY_HAV_MAT_MATERIAL_BLOCK_BLUNT_2HAND","Material Block Blunt 2Hand","Material Block Blunt 2Hand"),
            ("SKY_HAV_MAT_MATERIAL_SHIELD_HEAVY","Material Shield Heavy","Material Shield Heavy"),
            ("SKY_HAV_MAT_MATERIAL_ARMOR_HEAVY","Material Armor Heavy","Material Armor Heavy"),
            ("SKY_HAV_MAT_MATERIAL_ARROW","Material Arrow","Material Arrow"),
            ("SKY_HAV_MAT_GLASS","Glass","Glass"),
            ("SKY_HAV_MAT_STONE","Stone","Stone"),
            ("SKY_HAV_MAT_MATERIAL_WATER_PUDDLE","Material Water Puddle","Material Water Puddle"),
            ("SKY_HAV_MAT_CLOTH","Cloth","Cloth"),
...
class LowerCaseImagePaths(bpy.types.Operator):
    """Convert Image Paths To Lower Case"""
    
    bl_idname = "object.lowercaseimagepaths"
    bl_label = "Convert image paths to lower case"
    bl_options = {'REGISTER', 'UNDO'}

    def execute(self, context):
        time_start = time.time()
        print("Beginning lower case image paths...")
        
        for img in bpy.data.images:
            # check if there is an image at the file path case INsensetively
            filepath = bpy.path.resolve_ncase(img.filepath)
        ...
        print("Lower case image paths script finished in %.4f sec" % (time.time() - time_start))
        return {'FINISHED'}
...
def menu_func(self, context):
    ...
    self.layout.operator(LowerCaseImagePaths.bl_idname)
...
def register():
    ...
    bpy.utils.register_class(LowerCaseImagePaths)
    ...
    if kc:
        ...
        km = wm.keyconfigs.addon.keymaps.new(name='Object Mode', space_type='EMPTY')
        kmi = km.keymap_items.new(LowerCaseImagePaths.bl_idname, 'L', 'PRESS', ctrl=True, shift=True)
        addon_keymaps.append((km, kmi))
...
def unregister():
    ...
    bpy.utils.unregister_class(LowerCaseImagePaths)
